...
<link href="<?= base_url() ?>assets/css/estilos_extendidos.css?v=1.5" rel="stylesheet" />
...
<script src="<?= base_url() ?>assets/js/file-uploader/fileuploader.js?v=1.5"></script>
...
<script src="<?= base_url() ?>assets/js/common.js?v=1.5"></script>
<script src="<?= base_url() ?>assets/js/frontend_extendido.js?v=1.5"></script>

<script src="<?= base_url() ?>assets/js/ol-3.5.js?v=1.5" type="text/javascript"></script>
<script src="<?= base_url() ?>assets/js/calendario-sae.js?v=1.5" type="text/javascript"></script>

<link rel="stylesheet" href="<?= base_url() ?>assets/css/ol-3.5.css?v=1.5" type="text/css">
<link rel="stylesheet" href="<?= base_url() ?>assets/css/calendario-sae.css?v=1.5" type="text/css">
