...
if (!defined('CELL_WIDTH')) define('CELL_WIDTH', 33);
if (!defined('GRID_WIDTH')) define('GRID_WIDTH', 8);
...
class CertificadoPDF extends TCPDF {
    ...
    public function Footer() {
        ...
        $this->MultiCell(50, 8, 'Fecha de Emisión:', 0, 'L', false, 1, PAGE_MARGIN, $y,true,0,false,true,8,'M');

        $fecha_hoy = strftime("%A %d de %B del %Y");

        $this->MultiCell(2*CELL_WIDTH+GRID_WIDTH, 8, $fecha_hoy, 0, 'L', false, 1, PAGE_MARGIN+38, $y,true,0,false,true,8,'M');
        ...
        $this->MultiCell(4*CELL_WIDTH+3*GRID_WIDTH, '', implode(' ',str_split($this->key,4)), 0, 'L', false, 1, PAGE_MARGIN+47,$y+50);
        $this->SetFont('dejavusans', '', 10);
