$(document).ready(function() {
  ...
  $('#generar_reporte_completo').click(function(e) {
    ...
    */
    ...
    $.ajax({
      type: 'post',
      url: site_url+'backend/reportes/generar_completo/' + reporte_id + "?filtro_grupo=" + grupo + "&filtro_usuario=" + usuario + "&filtro_desde=" + desde + "&filtro_hasta=" + hasta,
  ...
  $('#generar_reporte_basico').click(function(e) {
    ...
    if(desde == "" || hasta == ""){
      ...
      $.ajax({
        type: 'post',
        url: site_url+'backend/reportes/generar_basico/' + reporte_id + "?&filtro_desde=" + desde + "&filtro_hasta=" + hasta,
        success: function(response) {
          resultado = $.parseJSON(response);
          if (resultado.email){
            ...
            window.location.href = site_url + "backend/reportes/ver/" + reporte_id + "?&filtro_desde=" + desde + "&filtro_hasta=" + hasta;
          }
        }
      });
    }
