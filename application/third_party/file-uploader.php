...
class qqFileUploader {
    ...
    function handleUpload($uploadDirectory, $replaceOldFile = FALSE) {
      ...
      $filename = $this->convert_ascii($pathinfo['filename']);
      $file_origen = $filename;
      ...
      $filename = str_replace(' ', '', $filename); //se remplazan espacios en blanco
      $filename = str_replace(',', '', $filename); //se remplazan las comas
