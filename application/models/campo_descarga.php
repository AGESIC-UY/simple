...
class CampoDescarga extends Campo {
    ...
    public function backendExtraFields() {
        ...
        $html="";
        $html.='<div class="control-group"><label class="control-label" for="tipo_documentoid">Tipo Documento:</label>';
        $html.='<div class="controls"><input type="text" id="tipo_documentoid" name="extra[tipo_documentoid]" placeholder="Tipo de Documento (pdf, xls, etc)" value="'.($tipo_documento?$tipo_documento:'').'" /></div></div>';
        return $html;
