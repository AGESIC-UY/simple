...
<option value="zw">	Zimbabue</option>
          ...
          <br>
          <div class="omnicanalidad">             
              <label style="text-align: justify">
                   <input type="checkbox" name="omnicanalidad_oid" id="omnicanalidad_oid"/>
                  “Vincular la cédula de identidad del ciudadano a la traza del trámite realizado.”</label>
          </div>
    </fieldset>
</form>
