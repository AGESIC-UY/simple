      ...
      <div class="form-horizontal">
        ...
        <div id="form_pdi">
          <div class="control-group">
            ...
            <div class="controls">
              <input id="timeout" class="input-small" type="text" value="<?= ($catalogo->conexion_timeout == 0 ? 10 : $catalogo->conexion_timeout) ?>" name="conexion_timeout_pdi"  />
              <label for="respuesta_timeout" class="hidden-accessible">Tiempo de espera de conexión y respuesta (segundos)</label>
              <input class="input-small" type="text" id="respuesta_timeout" value="<?= ($catalogo->respuesta_timeout == 0 ? 10 : $catalogo->respuesta_timeout) ?>" name="respuesta_timeout_pdi" title="Timeout de respuesta" />
            </div>
          </div>
          <div class="control-group">
