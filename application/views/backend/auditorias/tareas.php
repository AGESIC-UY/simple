<div class="row-fluid">
    ...
    <div class="span12">
       ...
       <table class="table" id="mainTable">
            <caption class="hide-text">Tareas</caption>
            <thead>
                <tr>
                    <th>Operación</th>
                    <th>Usuario</th>
            ...
            <tbody>
                ...
                <?php foreach ($lista as $v): ?>
                    <tr>
                        ...
                        <td><?= $v->final ?></td>  
                        <td class="actions">
                            <a class="btn btn-primary" href="<?= site_url('backend/auditorias/tareas_auditar/' . $v->id) ?>"><span class="icon-search icon-white"></span> Auditar<span class="hidden-accessible"></span></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
