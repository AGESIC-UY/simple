...
class Reporte extends Doctrine_Record {
    ...
    public function contar_generar_completo($grupo=null, $usuario=null, $desde=null, $hasta=null){
      set_time_limit(1600);
    ...
    public function contar_generar_basico($desde, $hasta){
      set_time_limit(1600);
      ini_set('memory_limit', '-1');
    ...
    public function generar_basico($desde, $hasta){
