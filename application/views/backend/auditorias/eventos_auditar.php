<div class="row-fluid">
    ...
    <div class="span12">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?= site_url('backend/auditorias/eventos/' . $tarea->id_aud) ?>">Eventos </a> <span class="divider">/</span>
            </li>
            <li class="active">Evento <?= ' ID : ' . $lista[0]->id ?></li>
        </ul>
        <?php $this->load->view('backend/auditorias/filtros_view') ?>
        <h2>Evento</h2>
        <?php $this->load->view('messages') ?>
            <table class="table" id="mainTable">
                <caption class="hide-text">Evento</caption>
                <thead>
                    <tr>
                        <th>Operación</th>
                        <th>Usuario</th>
