    ...
    <fieldset>
        ...
        <ul class="form-action-buttons">
            <li class="action-buttons-primary">
                <ul>
                    <li>
                      <?php if ($secuencia + 1 < count($etapa->getPasosEjecutables())): ?><a class="btn btn-primary" href="<?= site_url('etapas/ver/' . $etapa->id . '/' . ($secuencia + 1)) ?>">Siguiente<span class="icon-chevron-right icon-white"></span></a><?php endif; ?>
                    </li>
                </ul>
            </li>
            <li class="action-buttons-second">
                <ul>
                    <li class="float-left">
                      <?php if ($secuencia > 0): ?><a class="btn btn-link" href="<?= site_url('etapas/ver/' . $etapa->id . '/' . ($secuencia - 1)) ?>"><span class="icon-chevron-left"></span> Volver</a><?php endif; ?>
                    </li>
                </ul>
            </li>
        </ul>
