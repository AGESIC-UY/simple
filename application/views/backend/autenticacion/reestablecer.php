        ...
        <div class="container">
            <div class="row-fluid" style="margin-top: 100px;">
                <div class="span6 offset3">
                    <form method="post" class="well ajaxForm" action="<?= site_url('backend/autenticacion/reestablecer_form').'?'.$this->input->server('QUERY_STRING') ?>">
                        <fieldset>
                            ...
                            <label>E-Mail</label>
                            <input type="text" class="input-xlarge" value="<?=$usuario->email?>" disabled>
