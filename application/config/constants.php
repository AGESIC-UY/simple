...
define('WS_FIRMA_DOCUMENTOS', 'http://172.18.0.2:8080/AgesicFirmaWS/AgesicFirmaServer'); // -- Tomcat Webapp Firma.
define('WS_AGESIC_FIRMA','http://172.18.0.2:8080/AgesicFirmaWS/AgesicFirma?wsdl'); // -- Tomcat Webapp Firma.
define('WS_AGESIC_FIRMA_OK','http://simple.sofis.com.uy:80/etapas/confirmar_firma'); // -- Apache Simple.
define('WS_AGESIC_FIRMA_CODEBASE','http://simple.sofis.com.uy:81/'); // -- Apache Simple.
...
define('WS_AGESIC_TRAZABLIDAD_CABEZAL', 'http://conector-pge.ambientes.sofis:9800/cabezal?wsdl');
...
define('WS_VARIABLE_COD_TRAZABILIDAD', 'codigo_trazabilidad'); // -- GUID de traza
...
// -- Dominio.
define('DOMINIO', 'simple.sofis.com.uy');
...
define('SIMPLE_VERSION', 'Versión last');
...
// -- Configuracion LDAP
define('LDAP_HOST', '192.168.1.130');
define('LDAP_PUERTO', 389);
define('LDAP_BASE_DN', 'dc=simple,dc=sofis,dc=com,dc=uy');
define('LDAP_ATTR', 'cn');
define('LDAP_USER', 'cn=admin,dc=simple,dc=sofis,dc=com,dc=uy');
define('LDAP_PASS', 'sofis2uy');
