...
<script src="<?= base_url() ?>assets/js/common.js?v=1.5" type="text/javascript"></script>
<script src="<?= base_url() ?>assets/js/backend.js?v=1.5" type="text/javascript"></script>
<script src="<?= base_url() ?>assets/js/backend_extendido.js?v=1.5" type="text/javascript"></script>
<script src="<?= base_url() ?>assets/js/backend_ayuda_contextual.js?v=1.5" type="text/javascript"></script>
