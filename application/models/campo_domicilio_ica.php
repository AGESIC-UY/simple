...
class CampoDomicilioIca extends Campo {
    ...
    protected function display($modo, $dato, $etapa_id) {
        ...
        //select departamento
        $dato_departamento_nombre = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_departamento', $etapa_id);
        if ($dato_departamento_nombre) {
            $dato_departamento_nombre = $dato_departamento_nombre->valor;
        } else {
            $dato_departamento_nombre = "";
        }

        $dato_departamento_localidad = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_localidad', $etapa_id);
        if (!$dato_departamento_localidad || empty($dato_departamento_localidad)) {
            $dato_departamento_localidad = "''";
        } else {
            $dato_departamento_localidad = "'" . $dato_departamento_localidad->valor . "'";
        }
        $display .= ' <div class="control-group">';
        ...
        $display .= '   <div class="controls">';
        $domicilio_datos = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_calle', $etapa_id);
        $domicilio_datos = empty($domicilio_datos) ? "" : $domicilio_datos->valor;

        $numero_datos = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_numero', $etapa_id);
        $numero_datos = empty($numero_datos) ? "" : $numero_datos->valor;
        if ($domicilio_datos) {
            $dom = $domicilio_datos . " " . $numero_datos;
        } else {
            $dom = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_domicilio_busqueda', $etapa_id);
            $dom = empty($dom) ? "" : $dom->valor;
        }
        $display .= '       <input id="' . $this->id . '_domicilio_input_id" name="' . $this->id . '_domicilio_input_name" data-modo="' . $modo . '" type="text"  value="' . $dom . '" ' . ($modo == 'visualizacion' || $CI->uri->segment(3) == 'ver_etapa' || $CI->uri->segment(2) == 'ver_etapa' ? 'disabled' : '') . '>';
        $display .= '   </div>';
        $display .= ' </div>';
        ...
        //input calle
        $calle_input = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_calle', $etapa_id);
        $calle_input = empty($calle_input) ? "" : $calle_input->valor;
        $display .= ' <div class="control-group">';
        $display .= '    <label class="control-label" for="' . $this->id . '_calle_input_id">Calle*:</label>';
        $display .= '   <div class="controls">';
        $display .= '       <input id="' . $this->id . '_calle_input_id" name="calle" data-modo="' . $modo . '" type="text" value="' . $calle_input . '" ' . ($modo == 'visualizacion' || $CI->uri->segment(3) == 'ver_etapa' || $CI->uri->segment(2) == 'ver_etapa' ? 'disabled' : '') . '>';
        $display .= '           <span class="help-block">Ejemplo: 18 de Julio o Ruta 8</span>';
        $display .= '   </div>';
        $display .= ' </div>';

        //input número
        $numero_input = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_numero', $etapa_id);
        $numero_input = empty($numero_input) ? "" : $numero_input->valor;
        $display .= ' <div class="control-group">';
        $display .= '    <label class="control-label" for="' . $this->id . '_numero_input_id">Número:</label>';
        $display .= '   <div class="controls">';
        $display .= '       <input id="' . $this->id . '_numero_input_id" name="numero" data-modo="' . $modo . '" type="text" value="' . $numero_input . '" ' . ($modo == 'visualizacion' || $CI->uri->segment(3) == 'ver_etapa' || $CI->uri->segment(2) == 'ver_etapa' ? 'disabled' : '') . '>';
        $display .= '           <span class="help-block">Ejemplo: 1242 o Km 80</span>';
        $display .= '   </div>';
        $display .= ' </div>';

        //input esquina
        $esquina_input = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_esquina', $etapa_id);
        $esquina_input = empty($esquina_input) ? "" : $esquina_input->valor;
        $display .= ' <div class="control-group">';
        $display .= '    <label class="control-label" for="' . $this->id . '_esquina_input_id">Esquina:</label>';
        $display .= '   <div class="controls">';
        $display .= '       <input id="' . $this->id . '_esquina_input_id" name="esquina" data-modo="' . $modo . '" type="text" value="' . $esquina_input . '" ' . ($modo == 'visualizacion' || $CI->uri->segment(3) == 'ver_etapa' || $CI->uri->segment(2) == 'ver_etapa' ? 'disabled' : '') . '>';
        $display .= '   </div>';
        $display .= ' </div>';

        //input manzana
        $manzana_input = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_manzana', $etapa_id);
        $manzana_input = empty($manzana_input) ? "" : $manzana_input->valor;
        $display .= ' <div class="control-group">';
        $display .= '    <label class="control-label" for="' . $this->id . '_manzana_input_id">Manzana:</label>';
        $display .= '   <div class="controls">';
        $display .= '       <input id="' . $this->id . '_manzana_input_id" name="manzana" data-modo="' . $modo . '" type="text" value="' . $manzana_input . '" ' . ($modo == 'visualizacion' || $CI->uri->segment(3) == 'ver_etapa' || $CI->uri->segment(2) == 'ver_etapa' ? 'disabled' : '') . '>';
        $display .= '   </div>';
        $display .= ' </div>';

        //input solar
        $solar_input = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_solar', $etapa_id);
        $solar_input = empty($solar_input) ? "" : $solar_input->valor;
        $display .= ' <div class="control-group">';
        $display .= '    <label class="control-label" for="' . $this->id . '_solar_input_id">Solar:</label>';
        $display .= '   <div class="controls">';
        $display .= '       <input id="' . $this->id . '_solar_input_id" name="solar" data-modo="' . $modo . '" type="text" value="' . $solar_input . '" ' . ($modo == 'visualizacion' || $CI->uri->segment(3) == 'ver_etapa' || $CI->uri->segment(2) == 'ver_etapa' ? 'disabled' : '') . '>';
        $display .= '   </div>';
        $display .= ' </div>';

        //input padrón
        $padron_input = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_padron', $etapa_id);
        $padron_input = empty($padron_input) ? "" : $padron_input->valor;
        $display .= ' <div class="control-group">';
        $display .= '    <label class="control-label" for="' . $this->id . '_padron_input_id">Padrón*:</label>';
        $display .= '   <div class="controls">';
        $display .= '       <input id="' . $this->id . '_padron_input_id" name="padron" data-modo="' . $modo . '" type="text" value="' . $padron_input . '" ' . ($modo == 'visualizacion' || $CI->uri->segment(3) == 'ver_etapa' || $CI->uri->segment(2) == 'ver_etapa' ? 'disabled' : '') . '>';
        $display .= '           <span class="help-block">Ejemplo: 2256</span>';
        $display .= '   </div>';
        $display .= ' </div>';

        //input otros datos
        $datos_input = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_otros', $etapa_id);
        $datos_input = empty($datos_input) ? "" : $datos_input->valor;
        $display .= ' <div class="control-group">';
        $display .= '    <label class="control-label" for="' . $this->id . '_otros_input_id">Otros datos:</label>';
        $display .= '   <div class="controls">';
        $display .= '       <input id="' . $this->id . '_otros_input_id" name="otros" data-modo="' . $modo . '" type="text" value="' . $datos_input . '" ' . ($modo == 'visualizacion' || $CI->uri->segment(3) == 'ver_etapa' || $CI->uri->segment(2) == 'ver_etapa' ? 'disabled' : '') . '>';
        ...
        $display .= '       <button class="btn btn-secundary btn-lg ingresar-mas-datos" id="ir_form_punto_mapa">Buscar punto en el mapa</button>';
        $display .= '     </div>';

        $display .= ' <div id="confirmar_punto_mapa"class="control-group" style="display:none">';
        $display .= '   <button class="ingresar-mas-datos btn-link" id="ir_form_simplificado">Volver al formulario simplificado</button>';
        $display .= ' </div>';
        ...
        $busqueda_avanzada = Doctrine::getTable('DatoSeguimiento')->findByNombreHastaEtapa($this->nombre . '_busqueda_avazada', $etapa_id);
        $busqueda_avanzada = empty($busqueda_avanzada) ? "" : $busqueda_avanzada->valor;
        ...
        if ($etapa_id) {
            ...
            $display .= '$("#' . $this->id . '_procesar_busqueda_simple").click(function(event) {
                          ...
                          var dom = $("#' . $this->id . '_domicilio_input_id").val().trim();
                          var res = dom.split(" ");
                          var calle="";
                          ...
                          calle= calle.trim();
                          var limit=0' . is_null($this->extra->tamanio_limite) . ';
                          if(!limit){
                          limit=0' . $this->extra->tamanio_limite . ';
                          }
                          if((calle.length <  limit)){
                            $(".control-group.error").each(function(index, element) {
                              $(element).removeClass("error");
                            });
                            $("html, body").animate({ scrollTop: 0 }, "fast");
                            $(".validacion-error").html("<span class=\'dialog-title\'>Hay <strong>1 error</strong> en el formulario</span><div class=\'alert alert-error\'>1. <a href=\'#' . $this->id . '_domicilio_input_id\' class=\'error_link\'>En el campo \'<strong>Domicilio</strong>\' el nombre de la calle tiene que tener más de ' . $this->extra->tamanio_limite . ' caracteres.</a></div><div class=\'alert alert-error\'>").fadeIn();
                            $("#' . $this->id . '_domicilio_input_id").parent().parent().addClass("error");
                            $("#' . $this->id . '_domicilio_input_id").parent().append("<div class=\'mensaje_error_campo\'>En el campo \'Domicilio\' el nombre de la calle tiene que tener más de ' . $this->extra->tamanio_limite . ' caracteres.</div>");
                            return;
                          }
                              ...
                              .done(function(data) {
                                ...
                                if(data.error){
                                  ...
                                  if(data.lista == "error_interno"){
                                    $("html, body").animate({ scrollTop: 0 }, "fast");
                                    if(data.errores){
                                      $(".validacion-error").html(data.errores).fadeIn();
                                  ...
                                  jQuery.each(data.lista, function(key, domicilio_candidato) {
                                    ...
                                    $("#' . $this->id . '_seleccionar_domicilio_"+ key).click(function(event) {
                                      ...
                                      var datos_seguimiento_guardar = {
                                                    ...
                                                    "' . $this->nombre . '_Operacion": domicilio_candidato.Operacion,
                                                  };
            ...
            //boton procesar busqueda AVANZADA click
            $display .= '$("#' . $this->id . '_procesar_busqueda_avanzada").click(function(event) {
                                        ...
                                        if($("#' . $this->id . '_padron_input_id").val().trim() == "" && ($("#' . $this->id . '_calle_input_id").val().trim() == "")){
                                          $(".control-group.error").each(function(index, element) {
                                            $(element).removeClass("error");
                                          });
                                          $("html, body").animate({ scrollTop: 0 }, "fast");
                                          $(".validacion-error").html("<span class=\'dialog-title\'>Hay <strong>1 error</strong> en el formulario</span><div class=\'alert alert-error\'>1. Es obligatorio completar el campo <a href=\'#' . $this->id . '_padron_input_id\' class=\'error_link\'> \'<strong>Padrón</strong>\'</a> o el campo <a href=\'#' . $this->id . '_calle_input_id\' class=\'error_link\'> \'<strong>Calle</strong>\' .</a></div><div class=\'alert alert-error\'>").fadeIn();
                                          $("#' . $this->id . '_padron_input_id").parent().parent().addClass("error");
                                          $("#' . $this->id . '_padron_input_id").parent().append("<div class=\'mensaje_error_campo\'>El campo \'Padrón\' es obligatorio.</div>");
                                          ...
                                          var calle = $("#' . $this->id . '_calle_input_id").val().trim();
                                          var limit=0' . is_null($this->extra->tamanio_limite) . ';
                                         if(!limit){
                                            limit=0' . $this->extra->tamanio_limite . ';
                                            }
                                                            if(calle.length >0 && calle.length <  limit){
                                            $(".control-group.error").each(function(index, element) {
                                              $(element).removeClass("error");
                                            });
                                            $("html, body").animate({ scrollTop: 0 }, "fast");
                                            $(".validacion-error").html("<span class=\'dialog-title\'>Hay <strong>1 error</strong> en el formulario</span><div class=\'alert alert-error\'>1. <a href=\'#' . $this->id . '_calle_input_id\' class=\'error_link\'>El campo \'<strong>Calle</strong>\' tiene que tener más de ' . $this->extra->tamanio_limite . ' caracteres.</a></div><div class=\'alert alert-error\'>").fadeIn();
                                            $("#' . $this->id . '_calle_input_id").parent().parent().addClass("error");
                                            $("#' . $this->id . '_calle_input_id").parent().append("<div class=\'mensaje_error_campo\'>El campo \'Calle\' tiene que tener más de ' . $this->extra->tamanio_limite . ' caracteres.</div>");
                                            return;
                                          }
                                         
                                           var esquina = $("#' . $this->id . '_esquina_input_id").val().trim();
                                           
                                          
                                          if((esquina.length > 0 && esquina.length <  limit)){
                                            $(".control-group.error").each(function(index, element) {
                                              $(element).removeClass("error");
                                            });
                                            $("html, body").animate({ scrollTop: 0 }, "fast");
                                            $(".validacion-error").html("<span class=\'dialog-title\'>Hay <strong>1 error</strong> en el formulario</span><div class=\'alert alert-error\'>1. <a href=\'#' . $this->id . '_esquina_input_id\' class=\'error_link\'>El campo \'<strong>Esquina</strong>\' tiene que tener más de ' . $this->extra->tamanio_limite . ' caracteres.</a></div><div class=\'alert alert-error\'>").fadeIn();
                                            $("#' . $this->id . '_esquina_input_id").parent().parent().addClass("error");
                                            $("#' . $this->id . '_esquina_input_id").parent().append("<div class=\'mensaje_error_campo\'>El campo \'Esquina\' tiene que tener más de ' . $this->extra->tamanio_limite . ' caracteres.</div>");
                                            return;
                                          }
                                        ...
                                        $.ajax({
                                          ...
                                          data: {
                                                  ...
                                                  "padron": $("#' . $this->id . '_padron_input_id").val(),
                                                ...
                                                jQuery.each(data.lista, function(key, domicilio_candidato) {
                                                  ...
                                                  $("#' . $this->id . '_seleccionar_domicilio_"+ key).click(function(event) {
                                                    ...
                                                    var datos_seguimiento_guardar = {
                                                                  ...
                                                                  "' . $this->nombre . '_padron": $("input[name=padron]").val(),
            ...
            //boton ir formulario busqueda avanzada encontrado
            ...
            //boton ir formulario busqueda avanzada NO direccion encontrada
            $display .= '$("#ir_form_avanzado_no_encontrada").click(function(event) {
                                        ...
                                        $("#' . $this->id . '_agregar_datos_extra").click(function(event) {
                                          ...
                                          var datos_seguimiento_guardar = {
                                                                            ...
                                                                            "' . $this->nombre . '_padron_input_extra": $("input[name=padron_input_extra]").val(),
            ...
            //boton ir formulario busqueda simplificado
            ...
            //mapa con dato de seguimiento
            $display .= '$("#ir_form_punto_mapa").click(function(event) {
                    event.preventDefault();
                     $("#' . $this->id . '_domicilio_no_encontrado").hide();
                         $("#datos_domicilio").hide();
                          $("#datos_domicilio_extra").hide();                     
                        
                            jQuery.getScript("' . base_url() . 'assets/js/ol-3.5.js")
                            .done(function() {
                              //MOSTRAR MAPA
                                $("#' . $this->id . '_mapa").html("");                                
                                lon2 = "";
                                ...
                                if((lat2=="" || lat2=="0") && (lon2=="" || lon2=="0")) {
                                  lat2 = "-34.90568098852981";
                                  lon2 = "-56.193958003934256";
                                  zoom2 = 15;
                                }
                                var coord2 = ol.proj.fromLonLat([parseFloat(lon2), parseFloat(lat2)]);                               
                                ...
                                map.on("click", function(evt) {
                                    ...
                                    var lon = coord[0];
                                    var lat = coord[1];
                                    var coord2 = ol.proj.fromLonLat([parseFloat(lon), parseFloat(lat)]);
                                    //Capa del mapa
                                    var mapLayer = new ol.layer.Tile({
                                        source: new ol.source.OSM()
                                    });
                                    ...
                                    layerArray = this.getLayers().getArray(),
                                    ...
                                    var utm = "+proj=utm +zone=21 +south";
                                    var yacare = "+proj=longlat +ellps=intl +towgs84=-155.0,171.0,37.0,0.0,0.0,0.0,0.0 +no_defs";
                                    var xy = proj4(yacare,utm,[lon, lat]);
                                    var lon2 = xy[0];
                                    var lat2= xy[1];
                                    buscarPuntoMapa(lon2,lat2);                                
                                });
                                
                                //$("#' . $this->id . '_texto_mapa").show();
                                //$("#' . $this->id . '_texto_direccion").show().html("<p><strong></strong></p>");
                                //TERMINA MOSTRAR MAPA
                                
                            })
                            .fail(function(jqXHR, textStatus, errorThrown) {
                            });
                            $("#confirmar_punto_mapa").show();
                            });
                            function buscarPuntoMapa(x,y) {
                                          $.ajax({
                                          type: "POST",
                                          dataType: "json",
                                          url: document.Constants.host + "/modulo_direcciones_ica/procesar_busqueda_punto_mapa_ajax",
                                          data: {
                                                  "method": "POST",
                                                  "x": x,
                                                  "y": y
                                            ...
                                            .done(function(data) {
                                              ...
                                              else if(data.lista.calle == null){
                                              $("#' . $this->id . '_div_direcciones_candidatas").show();
                                                 $("#' . $this->id . '_div_direcciones_candidatas").html("No se encontraron resultados para las coordenadas marcadas");
                                              }
                                              else{
                                              $("#' . $this->id . '_div_direcciones_candidatas").html("");
                                              $("#' . $this->id . '_div_direcciones_candidatas").append(\'<button class="btn btn-info btn-lg" disabled id="' . $this->id . '_seleccionar_domicilio_mapa_\'+ 1 + \'" ><span class="icon-ok icon-white"></span> \' + data.lista.numero + " " + data.lista.calle + (data.lista.esquina=="" ? "" : " Esquina: " + data.lista.esquina )+ " || " + data.lista.ciudad+   \'</button>\').show();
                                              var str = data.lista.ciudad;
                                              var local = str.toLowerCase();
                                              $("#' . $this->id . '_departamento_select_id").val(local).change();
                                                  //se muestran botones con direcciones posbiles
                                                 var datos_seguimiento_guardar = {
                                                                  "' . $this->nombre . '_X": x,
                                                                  "' . $this->nombre . '_Y": y,
                                                                  "' . $this->nombre . '_calle": data.lista.calle,
                                                                  "' . $this->nombre . '_numero": data.lista.numero,
                                                                  "' . $this->nombre . '_localidad": data.lista.ciudad,
                                                                  "' . $this->nombre . '_esquina": data.lista.esquina,
                                                                  "' . $this->nombre . '_validacion_siguiente": "1",
                                                                  "' . $this->nombre . '_busqueda_punto_mapa": "1",
                                                                  "' . $this->nombre . '_Operacion": data.lista.operacion,
                                                                };
                          ...
                          ';
            //boton ir formulario busqueda simplificado
            $display .= '$("#confirmar_punto_mapa").click(function(event) {
                                      event.preventDefault();
                                      $("#datos_domicilio").hide();
                                      //$("#ir_form_punto_mapa").hide();
                                      $("#' . $this->id . '_div_direcciones_candidatas").hide();
                                      $("#confirmar_punto_mapa").hide();
                                      $("#datos_domicilio_extra").show();
                                      $(".mensaje_error_campo").hide();
                                      $(".validacion-error").hide();
                                      $("#' . $this->id . '_domicilio_no_encontrado").hide();
