      ...
      steps: [
        {
          ...
          content: "En este formulario usted podrá configurar las credenciales para utilizar la plataforma de interoperabilidad. Los datos requeridos son los siguientes: <br><br><ul><li><b>URL del servicio STS:</b> URL provista por PDI.</li><li><b>Nombre de la política:</b> Dato provisto por PDI.</li><li><b>Certificado de organismo:</b> Certificado con el cual se firmaran las invocaciones a PDI, debe estar en formato PKC12.</li><li><b>Contraseña del certificado de organismo:</b> Clave correspondiente al certificado anterior.</li><li><b>Certificado SSL:</b> Certificado en formato PEM para la conexión SSL con PDI. Debe ser tramitado con Agesic.</li><li><b>Contraseña del certificado SSL:</b> Clave correspondiente al certificado anterior.</li></ul>",
          placement: "top"
        }
      ],
      template: template,
