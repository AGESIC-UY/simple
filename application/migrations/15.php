...
class Migration_15 extends Doctrine_Migration_Base {
  ...
  public function up() {
    ...
    $this->addColumn('ws_catalogo', 'requiere_autenticacion', 'boolean');
    $this->addColumn('ws_catalogo', 'requiere_autenticacion_tipo', 'VARCHAR(100)');
    $this->addColumn('ws_catalogo', 'autenticacion_basica_user', 'VARCHAR(100)');
    $this->addColumn('ws_catalogo', 'autenticacion_basica_pass', 'VARCHAR(100)');
    $this->addColumn('ws_catalogo', 'autenticacion_basica_cert', 'VARCHAR(100)');
    $this->addColumn('ws_catalogo', 'autenticacion_basica_cert_pass', 'VARCHAR(100)');
    $this->addColumn('ws_catalogo', 'autenticacion_mutua_client', 'VARCHAR(100)');
    $this->addColumn('ws_catalogo', 'autenticacion_mutua_client_pass', 'VARCHAR(100)');
    $this->addColumn('ws_catalogo', 'autenticacion_mutua_server', 'VARCHAR(100)');
    $this->addColumn('ws_catalogo', 'autenticacion_mutua_user', 'VARCHAR(100)');
    $this->addColumn('ws_catalogo', 'autenticacion_mutua_pass', 'VARCHAR(100)');
    $this->addColumn('ws_catalogo', 'autenticacion_mutua_client_key', 'VARCHAR(100)');
    ...
    $this->addColumn('campo', 'ayuda_ampliada', 'longtext');
    $this->changeColumn('campo', 'fieldset', 'VARCHAR(400)', null, array('notnull' => 1));
    $this->addColumn('campo', 'documento_tramite', 'boolean');
    $this->addColumn('campo', 'email_tramite', 'boolean');
    ...
    // --
    $this->addColumn('usuario', 'acceso_reportes', 'boolean');

    // --
    // -- Modifica tabla File
    // --
    $this->addColumn('file', 'firmado', 'boolean');
    ...
    $this->addColumn('pasarela_pago_antel', 'id_organismo', 'VARCHAR(10)');
    $this->addColumn('pasarela_pago_antel', 'cuerpo_email_inicio', 'VARCHAR(700)');
    $this->addColumn('pasarela_pago_antel', 'cuerpo_email_ok', 'VARCHAR(700)');
    $this->addColumn('pasarela_pago_antel', 'cuerpo_email_pendiente', 'VARCHAR(700)');
    $this->addColumn('pasarela_pago_antel', 'cuerpo_email_timeout', 'VARCHAR(700)');
    $this->addColumn('pasarela_pago_antel', 'tema_email_inicio', 'VARCHAR(300)');
    $this->addColumn('pasarela_pago_antel', 'tema_email_ok', 'VARCHAR(300)');
    $this->addColumn('pasarela_pago_antel', 'tema_email_pendiente', 'VARCHAR(300)');
    $this->addColumn('pasarela_pago_antel', 'tema_email_timeout', 'VARCHAR(300)');

    // --
    // -- Modifica tabla Cuenta
    // --
    $this->addColumn('cuenta', 'codigo_analytics', 'VARCHAR(700)');
    $this->addColumn('cuenta', 'correo_remitente', 'VARCHAR(255)');
  }
}
