...
class ReporteCompleto extends CI_Controller {
  ...
  public function generar($data) {
    ...
    echo 'Reporte:'.$data->reporte_id .PHP_EOL;
    echo '$filtro_grupo:'.$data->filtro_grupo.PHP_EOL;
    echo '$filtro_usuario:'.$data->filtro_usuario.PHP_EOL;
    echo '$filtro_desde:'.$data->filtro_desde.PHP_EOL;
    echo '$filtro_hasta:'.$data->filtro_hasta.PHP_EOL;
    echo '$email:'.$data->email.PHP_EOL;

    $reporte_id = $data->reporte_id;
    $filtro_grupo = $data->filtro_grupo;
    $filtro_usuario= $data->filtro_usuario;
    ...
    //genera el reporte
    ob_start();
    $reporte->generar_completo($filtro_grupo, $filtro_usuario, $filtro_desde, $filtro_hasta);
    ...
    //https://stackoverflow.com/questions/18128250/codeigniter-rename-email-attachment-file
