...
class CampoTablaResponsive extends Campo{
        ...
        $display .= '<script type="text/javascript">
            ...
            function accionFs'.$this->id.'(b, row_number) {
             ...
             $.blockUI({
              ...
              $.ajax({
                type: "post",
                url: document.Constants.host + "/tabla/accion/'.$etapa->id.'",
    ...
    public function backendExtraFields() {
        ...
        $output.='<label class="control-label" for="accion_error">Variable con el  error</label>';
        $output.='<div class="controls"><input type="text" id="accion_error" name="extra[accion_error]" placeholder="Varianle con el error de la accioón" value="'.($accion_error?$accion_error:'').'" /></div>';
