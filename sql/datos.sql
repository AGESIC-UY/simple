...
INSERT INTO `ws_catalogo` (`nombre`, `id`, `wsdl`, `endpoint_location`, `activo`, `conexion_timeout`, `respuesta_timeout`, `tipo`) VALUES
('Servicio DNIC', 36, 'http://localhost:9800/dnic/servicioci?wsdl', 'http://localhost:9800/dnic/servicioci', 1, 10, 10, 'soap');
