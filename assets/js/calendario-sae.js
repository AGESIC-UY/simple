...
function disponibilidadFecha(date) {
	if(document.getElementById("fechas_disponibles")!=null && document.getElementById("fechas_disponibles").value != "") {
		var date_array = document.getElementById("fechas_disponibles").value;
...
$(document).on('focus', '.datepicker',  function() {
	if (document.getElementById('formatoFecha')){
