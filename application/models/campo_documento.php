    ...
    public function backendExtraFields() {
        ...
        if (isset($d)) {
           ...
           /*$html .= '<div class="control-group">
                <div>
                    <label for="check_firma_electronica_tipo">Componente de firma</label>
                    <select id="check_firma_electronica_tipo" name="extra[firmar_componente]">

                            <option value="1" selected="">PFEA</option>
                            <option value="2">Java Web Start</option>
            ...
            $html .= '<script>// -- Manejo de checkbox para firmas de documentos en servidor
                  $(document).ready(function() {
                      ...
                      $("#firmar").change(function() {
                       ...
                       /* $("#check_firma_electronica_tipo").change(function() {
                          if($("#check_firma_electronica_tipo").val()==1) {
                              $("#firmar").hide();
                          }
                          else {
                              $("#firmar").show();
