        ...
        <div class="well">
            ...
            <form id="reasignarFormCiudadano" method="POST" action="<?= site_url('backend/seguimiento/reasignar_form_ciudadano/' . $etapa->id) ?>" class="ajaxForm hide">
                ...
                <div class='control-group'>
                    ...
                    <div class='controls'>
                        <input name="documento" value="<?= isset($documento) ? $documento : "" ?>" id="documento" type="text" />
                    </div>
                </div>
                <div class='control-group'>
            ...
            <fieldset>
                <?php if (isset($paso)): ?>
                    ...
                    <?php foreach ($paso->Formulario->Campos as $c): ?>
                        <?php
                        if ($c->tipo == 'agenda_multiple_sae') {
                            $c->readonly = true;
                        }
                        ?>
                        <?php if ($c->tipo == 'tabla_datos'): ?>
                            <?php $c->extra->tipo_tabla_datos = "visualizar"; ?>
