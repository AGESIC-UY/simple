...
class Trazabilidad {
  ...
  public function perform() {
      ...
      if($cabezal == 1) {
        ...
        $sql = "insert into dato_seguimiento (etapa_id, nombre, valor) values ('".$etapa_id."', '".WS_VARIABLE_COD_TRAZABILIDAD."', '".$cod_traza[0]."')";
       ...
       <soapenv:Body>
         <lin:persist>
            <traza>
               ...
               <paso>'. $paso .'</paso>
               <descripcionDelPaso>'. $nombre_tarea .' - '. $nombre_paso .'</descripcionDelPaso>
