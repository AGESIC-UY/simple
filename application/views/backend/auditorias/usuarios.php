            ...
            <tbody>
                ...
                <?php foreach ($usuarios as $u): ?>
                    <tr>
                        ...
                        <td><?= $u['apellidos'] ?></td>                          
                        <td class="actions">
                            <a class="btn btn-primary" href="<?= site_url('backend/auditorias/usuario_auditar/' . $u['id']) ?>"><span class="icon-search icon-white"></span> Auditar<span class="hidden-accessible"> <?= $u->usuario ?></span></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
