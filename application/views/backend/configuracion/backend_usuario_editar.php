                                ...
                                <div class="help-block lista_de_roles" style="font-size:8pt;">
                                    <dl>
                                        ...
                                        <div id="seguimiento">
                                            ...
                                            <div>
                                                <label class="checkbox" for="seg_alc_auditor"><input type="checkbox" id="seg_alc_auditor" name="seg_alc_auditor" value="1" <?= isset($usuario) && $usuario->seg_alc_auditor ? 'checked' : '' ?> /> Auditoría</label>
                                            </div>
                                        </div>
